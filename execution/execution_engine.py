...
from execution.risk_engine import RiskEngine, get_risk_engine
...
class ExecutionEngine:
    ...
    def __init__(
        ...
        # Callbacks
        self.on_order_filled: Callable | None = None
        self.on_position_opened: Callable | None = None
        self.on_position_closed: Callable | None = None
    ...
    async def place_market_order(
        ...
        logger.info(
            f"Created market order: {order_id} {side.value.upper()} ${size:.2f}"
        )
