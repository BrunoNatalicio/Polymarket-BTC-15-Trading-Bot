...
class CoinbaseDataSource:
    ...
    async def get_order_book(self, level: int = 2) -> dict[str, Any] | None:
        """
        Get order book data.
    ...
    async def get_24h_stats(self) -> dict[str, Any] | None:
        """
...
_coinbase_instance: CoinbaseDataSource | None = None
