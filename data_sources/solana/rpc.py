...
class SolanaRPCDataSource:
    ...
    async def get_pyth_price(self) -> Decimal | None:
        """
        ...
        try:
            ...
            payload = {
                ...
                "params": [self.pyth_btc_address, {"encoding": "base64"}],
            }
    ...
    async def get_token_supply(self, token_mint: str) -> dict[str, Any] | None:
        """
        ...
        try:
            ...
            if "result" in result and len(result["result"]) > 0:
                ...
                return {
                    ...
                    "tps": perf.get("numTransactions", 0)
                    / max(perf.get("samplePeriodSecs", 1), 1),
                }
...
# Singleton instance
_solana_instance: SolanaRPCDataSource | None = None
