...
class BTCStrategy15Min:
    ...
    def __init__(
        ...
        self._spot_price_consensus: Decimal | None = None
        self._sentiment_score: float | None = None
    ...
    def update_market_data(
        self,
        price: Decimal,
        spot_consensus: Decimal | None = None,
    ...
    async def _wait_for_next_interval(self) -> None:
        ...
        logger.info(
            f"Waiting {wait_seconds:.0f}s until next decision ({next_time.strftime('%H:%M')})"
        )
    ...
    def get_statistics(self) -> dict[str, Any]:
        ...
        return {
            ...
            "last_decision": self._last_decision_time.isoformat()
