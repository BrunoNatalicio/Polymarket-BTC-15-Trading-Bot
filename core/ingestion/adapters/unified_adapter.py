...
class UnifiedDataAdapter:
    ...
    def __init__(self):
        ...
        # Data sources
        self.coinbase: CoinbaseDataSource | None = None
        self.binance: BinanceWebSocketSource | None = None
        self.news_social: NewsSocialDataSource | None = None
        self.solana: SolanaRPCDataSource | None = None

        # Callbacks
        self.on_price_update: Callable[[MarketData], None] | None = None
        self.on_sentiment_update: Callable[[SentimentData], None] | None = None
        ...
        self._latest_sentiment: SentimentData | None = None
    ...
    def get_latest_price(self, source: str | None = None) -> Decimal | None:
        """
    ...
    def get_price_consensus(self) -> dict[str, Any] | None:
        """
        ...
        return {
            ...
            "sources": {
                source: float(data.price) for source, data in self._latest_data.items()
            },
        }

    def get_latest_sentiment(self) -> SentimentData | None:
...
# Singleton instance
_adapter_instance: UnifiedDataAdapter | None = None
