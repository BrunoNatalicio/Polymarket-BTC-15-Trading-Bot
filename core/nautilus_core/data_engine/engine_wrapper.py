...
class NautilusDataEngineWrapper:
    ...
    def __init__(self):
        ...
        self.data_provider: CustomDataProvider | None = None
    ...
    def get_latest_quote(self, instrument_id: InstrumentId) -> any | None:
        return self.cache.quote(instrument_id)

    def get_latest_trade(self, instrument_id: InstrumentId) -> any | None:
    ...
    def get_status(self) -> dict:
        return {
            ...
            "data_provider_connected": (
                ...
                and self.data_provider.adapter is not None
            ),
        }
