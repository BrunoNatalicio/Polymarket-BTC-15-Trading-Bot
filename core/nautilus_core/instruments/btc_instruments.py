...
def create_btc_polymarket_instrument() -> CryptoPerpetual:
    ...
    instrument = CryptoPerpetual(
        instrument_id=InstrumentId(
            symbol=Symbol("BTC-POLYMARKET"), venue=Venue("POLYMARKET")
        ),
...
def create_btc_spot_instrument() -> CryptoPerpetual:
    ...
    """
    instrument = CryptoPerpetual(
        instrument_id=InstrumentId(symbol=Symbol("BTC-USD"), venue=Venue("COINBASE")),
...
class InstrumentRegistry:
    ...
    def __init__(self):
        ...
        logger.info(
            f"Initialized instrument registry with {len(self.instruments)} instruments"
        )
